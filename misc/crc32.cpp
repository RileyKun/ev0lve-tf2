...
static const uint32_t pulCRCTable[NUM_BYTES] =
{
...
void crc32::init(uint32_t *crc) {
    *crc = CRC32_INIT_VALUE;
}

void crc32::process_buffer(uint32_t *pulCRC, void *pBuffer, int nBuffer) {
    auto ulCrc = *pulCRC;

//
// Created by ruppet on 4/22/2020.
//

#ifndef EV0LVE_JOAAT_H
#define EV0LVE_JOAAT_H
...
#define JOAAT_IMPL(str) (::rage::constexpr_joaat<sizeof(str) - 1>((str), std::make_index_sequence<sizeof(str) - 1>())())
#define JOAAT(str) (std::integral_constant<rage::joaat_t, JOAAT_IMPL(str)>::value)

#endif //EV0LVE_JOAAT_H
